...
public class T {
    ...
    public void  t1() throws ParseException {
        String appID="wx8de42a966cca8b70";
        String appsecret="e053de8a2d8884175545884a73d44166";
    ...
    public void send(String token,Weather w,Content c) throws ParseException {
        ...
        sendData.setDay1(new Item(DateUtils.dayForLastDay(wx.getDay1()),"#fee140"));
        //附加数据
        //计算时间
