...
public class Send {
     ...
     * @param w
     */
    public void send1(String token, Weather w, String userid) {
    ...
    public void send2(String token, String userid) throws ParseException {
        ...
        //距离宝贝生日多少天
        sd.setDay2(new Item(DateUtils.dayToBirthday(wx.getDay2()), "#fee140"));
        //距离我出生多少天
        ...
        //附加文本数据
        sd.setTxt1(new Item("宝贝，今天也很爱你哦!", "#cd9cf2"));
        sd.setTxt2(new Item("还有很长的日子，要一直陪你走下去!", "#cd9cf2"));
        sendJson.setData(sd);
        String s = restTemplate.postForObject(url, sendJson, String.class);
        log.info("send2 info s:{}", s);
    }
